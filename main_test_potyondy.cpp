...
#include "part.h"
#include "distance.h"
#include "bond_prop_potyondy.h"
#include "bond_potyondy.h"
...
int main()
{
    ...
    out_file.open("data_test_hybrid_shear_vel.csv");
    out_file << "timestep,ID,x,y,z,u,v,w,fx,fy,fz,omx,omy,omz,tx,ty,tz\n";
    int const n_out = 1000;
    bool flag = false;
...
//            vec_part[1].setPos(x);
        ...
        bondino = &vec_bond;
        bond_potyondy(bondino, vec_part[0], vec_part[1], gamma, dt);
        ...
        if (i==0)
            std::cout << "normal force: " << vec_bond.getForce_n()[0] << "," << vec_bond.getForce_n()[1] << "," << vec_bond.getForce_n()[2] << "\n"
                      ...
                      << "shear-trans torque: " << vec_bond.getTorque_s()[0] << "," << vec_bond.getTorque_s()[1] << "," << vec_bond.getTorque_s()[2] << "\n";
