...
public:
    ...
    Part(double x, double y, double z, double x_in, double y_in, double z_in, double u, double v, double w, double omx, double omy, double omz, double fx, double fy, double fz, double tx, double ty, double tz) :
        r_{x, y, z},
...
private:
    double r_[3], r_in_[3], U_[3], U_old_[3], om_[3], f_[3], f_old_[3], t_[3], t_old_[3], m_, d_;
    int id_;
};
